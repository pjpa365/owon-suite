...
# A decode_places value of 7 (0b111, the max a 3-bit field can hold) is a
# sentinel meaning "no valid reading" -- confirmed by recording with the
# leads open: the type-word decodes with decimal_places=7 and all following
# value-words are zero placeholders. This is the offline-record equivalent
# of the live "OL" status flag.
